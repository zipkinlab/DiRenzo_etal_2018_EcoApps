...
#---------------- Logit Scale
    lpsi_NI[i, k] <- alpha_NI 
#+ beta_NI * covScale[i, k]
...
(1-mean(days3))/sd(days3)

((1 * sd(days3)) + mean(days3)) - mean(days3)
...
#setwd("/Users/Cici/GitHub/2010to2014ElCope/FINAL D-M model/Model_output/")


#save(out4, file = "years2010to2014_prior001_001.rda")
