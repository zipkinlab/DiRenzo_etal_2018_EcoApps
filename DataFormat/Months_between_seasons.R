...
#theta <- read.csv(file = "/Users/Cici/Dropbox/PhD_cope/Chpt2/Models/Data_20m/theta2.csv")[,-1]
...
days3 <- cbind(rep(12, times = nrow(days3)), rep(12, times = nrow(days3)), rep(12, times = nrow(days3)), rep(12, times = nrow(days3)),days3)
