...
#--- These values can be higher than host abundance because some individuals were likely recaptured and reswabbed multiple times per season.
...
#setwd("/Users/Cici/Desktop/Chpt 2 June 2016/")
#ggsave("Fig 2 21 July 2017.pdf", width = 8, height = 8)
